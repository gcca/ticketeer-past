...
inline void RegisterRoutes(crow::SimpleApp &app) {
  ...
  CROW_ROUTE(app, "/ticketeer/api/v1/helpdesk/administrator/technicians")
      .methods(crow::HTTPMethod::GET)(
          cr::Handler<LoginRequired, RoleRequired<Role::administrator>>(
              ListTechnicians<ticketeer::db::Pg>));

  CROW_ROUTE(app, "/ticketeer/api/v1/helpdesk/roles/administrator/tickets")
      .methods(crow::HTTPMethod::GET)(
          cr::Handler<LoginRequired, RoleRequired<Role::administrator>>(
              AdminTickets<ticketeer::db::Pg>));
}
